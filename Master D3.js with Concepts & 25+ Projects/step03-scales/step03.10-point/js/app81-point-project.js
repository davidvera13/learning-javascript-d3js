document.querySelector('button')
    .addEventListener('click', () => {
        ...
        if (onePt === 0 && twoPt === 0 && threePt === 0) {
            ...
            console.log('widthScale(0)', widthScale(0))
            console.log('widthScale(1)', widthScale(1))
            console.log('widthScale(2)', widthScale(2))
            console.log('widthScale.step()', widthScale.step())

            // console.log(radiusScale(0));

            d3.select('svg')
                .selectAll('rect')
                .data([onePt, twoPt * 2, threePt * 3])
                .join('rect')

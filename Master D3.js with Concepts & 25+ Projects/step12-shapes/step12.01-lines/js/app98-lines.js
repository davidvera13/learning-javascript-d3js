...
//     .attr('id', 'line1')
//     .selectAll('line')
//     // cannot do like this as this will append a line element for each data point
//     .data([point1, point2])
//     .join('line');

let linePoints = d3.merge([point1, point2]);
console.log(linePoints); // single array with 4 values
...
d3.select('svg')
    ...
    // .attr('d', d3.line((d, i) => console.log(d, i)))
    // .attr('d', d3.line((d, i) => console.log(d, i), (d, i) => console.log(d, i)))
    .attr('d', d3.line().x(d => d[0]).y(d => d[1]+30))
    .style('stroke', 'black')
    .style('fill', 'none')

...
/*
    ...
    and %), or the number of significant digits (types  ​, e, g, r, s and p). If the precision is not specified,
    it defaults to 6 for all types except ​ (none), which defaults to 12. Precision is ignored for formats (types b,
    o, d, x, X and c)
...
FORMAT_FN = LOCAL_FORMAT.format('*^+$25,.2f');
console.log(FORMAT_FN(value1));
console.log(FORMAT_FN(value2));

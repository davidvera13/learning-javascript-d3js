...
const SVG_WIDTH = document
    .querySelector('svg')
    .clientWidth;
const SVG_HEIGHT = document
    .querySelector('svg')
    .clientHeight;
...
// If duration and ease needed then ease --> duration
...
// Process B
// 1. only duration
// let transition1 = d3.transition()
//   .duration(2000);
// console.log(transition1);
// transition is configured and can be passed to object
// allRect.transition(transition1)
//   .attr('height', d => d * 3)
//   .attr('fill', 'khaki');
...
//   .delay(1000)
//   .duration(2000);
// let transition2 = d3.transition()
//   .delay(1000)
//   .duration(2000);
// allRect
//   .transition(transition1)
//   .attr('height', d => d * 3)
//   .transition(transition2) // if commented, both transition will be simultaneous
//   .style('fill', 'khaki');
...
//   .transition(transition1)
//   .attr('height', d => d * 3)
//   .transition(transition2) // can comment this
//   .style('fill', 'khaki');
